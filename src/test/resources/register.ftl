...
<div id="github">
    <br>
    <button class="hover" onclick="$('#github').hide();$('.form').show()">注册本地账号</button>
    <br>
    <a href="${loginURL}"><span>已有账号？去登录</span></a>
</div>
<div class="form none">
    <label for="userEmail">
    登录邮箱：
    ...
    <button onclick='getUserInfo();'>注册用户</button>
    <a href="${servePath}/register"><span>返回</span></a>
    <span id="tip" ></span>
</div>
